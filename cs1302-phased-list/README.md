# CSCI 1302 - Phased List (Phase 1) v2022.sp
...
project assigned to the students in the Spring 2022 CSCI 1302 classes
...
* **THU 2021-03-17 (Mar 17) @ 11:55 PM EST (`+20` SB Extra Credit)**
* **SAT 2021-03-19 (Mar 19) @ 11:55 PM EST (`+10` SB Extra Credit)**
* **MON 2021-03-21 (Mar 21) @ 11:55 PM EST (`+0` SB Extra Credit)**
...
1. Preparation (Suggested Deadline: Monday, Feb 28th):
...
1. Before you write any code (Suggested Deadline: Tuesday, Mar 1st):
...
1. Prepare to implement the methods (Suggested Deadline: Wednesday, Mar 2nd):
...
1. <a id="tests"/>Start by implementing a few methods in `BaseStringList` (Suggested Deadline: Thursday, Mar 3rd).
...
1. Implement `ArrayStringList` (Suggested Deadline: Friday, Mar 4th):
...
1. Implement `LinkedStringList` (Suggested Deadline: Monday, Mar 14th):
...
1. Implement `BaseStringList` (Suggested Deadline: Wednesday, Mar 16th):
...
1. Final Run-through (Suggested Deadline: Thursday, Mar 17th):
